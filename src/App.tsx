...
const LoginWithReset: React.FC = () => {
  ...
  // Add a unique key that changes when logging out
        ...
        <Routes>
          ...
          <Route element={<MainLayout />}>
            ...
            <Route path="/modules/fundraising">
              ...
              <Route
                path="opportunity-tracking"
                element={<OpportunityTracking />}
              />
              <Route
                path="opportunity-pipeline"
              ...
              <Route
                index
                element={
                  <Navigate to="/modules/fundraising/dashboard" replace />
                }
              />
            </Route>
            ...
            <Route path="/modules/program-management">
              ...
              <Route
                ...
                element={
                  <Navigate
                    to="/modules/program-management/dashboard"
                    replace
                  />
                }
              />
            ...
            <Route path="/modules/procurement">
              ...
              <Route
                index
                element={
                  <Navigate to="/modules/procurement/dashboard" replace />
                }
              />
            </Route>
            ...
            <Route path="/modules/inventory">
              ...
              <Route
                index
                element={<Navigate to="/modules/inventory/dashboard" replace />}
              />
            </Route>
            ...
            <Route path="/modules/finance">
              ...
              <Route
                index
                element={<Navigate to="/modules/finance/dashboard" replace />}
              />
            </Route>
            ...
            <Route path="/modules/learning">
              ...
              <Route
                index
                element={<Navigate to="/modules/learning/dashboard" replace />}
              />
            </Route>
            ...
            <Route path="/modules/document">
              ...
              <Route
                index
                element={<Navigate to="/modules/document/dashboard" replace />}
              />
            </Route>
            ...
            <Route path="/modules/hr">
              ...
              <Route
                index
                element={<Navigate to="/modules/hr/dashboard" replace />}
              />
            </Route>
            ...
            <Route path="/modules/user-management">
              ...
              <Route
                index
                element={
                  <Navigate to="/modules/user-management/dashboard" replace />
                }
              />
            </Route>
            ...
            <Route path="/modules/grants-management">
              ...
              <Route
                index
                element={
                  <Navigate to="/modules/grants-management/dashboard" replace />
                }
              />
            </Route>
            ...
            <Route
              path="/dashboard"
              element={<Navigate to="/modules/fundraising/dashboard" replace />}
            />
            <Route
              path="/donor-management"
              element={
                <Navigate to="/modules/fundraising/donor-management" replace />
              }
            />
            <Route
              path="/opportunity-tracking"
              element={
                <Navigate
                  to="/modules/fundraising/opportunity-tracking"
                  replace
                />
              }
            />
            <Route
              ...
              element={
                <Navigate
                  to="/modules/fundraising/proposal-management"
                  replace
                />
              }
            />
            <Route
              ...
              element={
                <Navigate
                  to="/modules/fundraising/fundraising-analytics"
                  replace
                />
              }
            />
            <Route
              path="/settings"
              element={<Navigate to="/modules/fundraising/settings" replace />}
            />
            ...
            <Route
              path="/modules"
              element={<Navigate to="/modules/fundraising" replace />}
            />
          </Route>

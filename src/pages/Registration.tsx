...
const Registration: React.FC = () => {
  ...
  const selectOptions = MODULES.filter(
    (mod) => mod.id !== "dashboard" && mod.id !== "settings" && mod.id !== "donor-management"
  );
      ...
      <div className="w-full max-w-xl bg-gradient-to-br from-violet-800 via-purple-900 to-fuchsia-900/95 rounded-xl shadow-2xl px-6 py-7 my-10 flex flex-col items-center">
        ...
        {step === "form" ? (
          ...
          <div className="w-full flex flex-col items-center mt-2">
            <h3 className="text-lg text-white font-bold mb-5">Confirm Registration Details</h3>
            <div className="bg-violet-950/70 rounded-lg p-5 w-full max-w-md flex flex-col gap-3 mb-4">
              <div className="flex flex-col gap-1">
                <span className="text-sm text-violet-200">Organization Name</span>
                <span className="text-base text-white font-semibold">{orgName}</span>
              </div>
              <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-base text-white font-semibold">{telephone}</span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-sm text-violet-200">Country</span>
                <span className="text-base text-white font-semibold">{country}</span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-sm text-violet-200">Selected Modules</span>
